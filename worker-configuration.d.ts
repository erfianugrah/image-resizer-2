// Generated by Wrangler by running `wrangler types` (hash: f02d7cc40bb3d073d331e1519fc48a12)
...
declare namespace Cloudflare {
	interface Env {
		...
		IMAGE_METADATA_CACHE_DEV: KVNamespace;
		IMAGE_TRANSFORMATIONS_CACHE_DEV: KVNamespace;
		ENVIRONMENT: "development" | "staging" | "production";
		DEBUG: "true";
		REMOTE_URL: "https://cdn.erfianugrah.com" | "https://example.com/images" | "https://25f21f141824546aa72c74451a11b419.r2.cloudflarestorage.com/images-weur/";
		FALLBACK_URL: "https://placehold.com" | "https://cdn.erfianugrah.com";
		STORAGE_PRIORITY: "r2,remote,fallback" | "remote";
		...
		DETECTOR_CACHE_MAX_SIZE: "5000" | "2000" | "10000";
		DETECTOR_CACHE_PRUNE_AMOUNT: "500" | "200" | "1000";
		DETECTOR_CACHE_ENABLE: "true";
		DETECTOR_CACHE_TTL: "3600000" | "300000" | "1800000";
		...
		DETECTOR_STRATEGY_USER_AGENT_MAX_LENGTH: "200" | "150" | "100";
		...
		DETECTOR_QUALITY_HIGH_TARGET: "90" | "85";
		DETECTOR_FORMATS_LOW: "webp,jpeg";
		DETECTOR_FORMATS_MEDIUM: "webp,avif,jpeg" | "avif,webp,jpeg";
		...
		DETECTOR_HASH_ALGORITHM: "fnv1a" | "simple";
		DETECTOR_LOG_LEVEL: "warn" | "debug" | "info";
		CACHE_TAGS_ENABLED: "true";
		CACHE_TAGS_PREFIX: "img-dev-" | "img-staging-" | "img-prod-";
		CACHE_TAGS_CUSTOM: "dev,test" | "staging,test" | "";
		CACHE_TAGS_PARSE_METADATA: "true";
		CACHE_USE_MULTIPLE_TAG_HEADERS: "false";
		CACHE_TAGS_MAX_TAGS: "10";
		CACHE_TAGS_SIMPLIFIED: "true";
		CACHE_TAGS_PATH_GROUPS: {"products":["product-catalog","e-commerce"],"blog":["blog-content","articles"],"profile":["user-content","avatars"]};
		CACHE_TTL_OK: "60" | "3600" | "604800";
		CACHE_TTL_CLIENT_ERROR: "10" | "30" | "60";
		CACHE_TTL_SERVER_ERROR: "5" | "10";
		CACHE_TTL_REMOTE_FETCH: "60" | "1800" | "86400";
		CACHE_TTL_R2_HEADERS: "60" | "3600" | "604800";
		CACHE_METHOD: "cf" | "cache-api";
		CACHE_EVERYTHING: "true" | "false";
		CACHE_USE_TTL_BY_STATUS: "true" | "false";
		TRANSFORM_CACHE_ENABLED: "true";
		TRANSFORM_CACHE_BINDING: "IMAGE_TRANSFORMATIONS_CACHE" | "IMAGE_TRANSFORMATIONS_CACHE_DEV";
		TRANSFORM_CACHE_USE_WAITUNTIL: "true";
		TRANSFORM_CACHE_OPTIMIZED_INDEXING: "true";
		TRANSFORM_CACHE_SKIP_SMALL_FILES: "true";
		TRANSFORM_CACHE_SMALL_FILE_SIZE: "51200" | "102400";
		TRANSFORM_CACHE_SMALL_PURGE_THRESHOLD: "20" | "50";
		TRANSFORM_CACHE_INDEX_FREQUENCY: "10" | "5" | "20";
		TRANSFORM_CACHE_RESPECT_CLIENT_CACHE_CONTROL: "false";
		CACHE_STATUS_SUCCESS_RANGE: "200-299" | "200-206,226";
		CACHE_STATUS_REDIRECT_RANGE: "301-302,307" | "301-302" | "301-302,307-308";
		CACHE_STATUS_NOTFOUND_RANGE: "404,410" | "404" | "404,410,451";
		CACHE_STATUS_ERROR_RANGE: "500-503,507" | "500-504";
		CACHE_TTL_STATUS_SUCCESS: "60" | "3600" | "604800";
		CACHE_TTL_STATUS_REDIRECT: "30" | "1800" | "86400";
		CACHE_TTL_STATUS_NOTFOUND: "10" | "30" | "60";
		CACHE_TTL_STATUS_ERROR: "5" | "10";
		FORMAT_QUALITY_WEBP: "80" | "85";
		FORMAT_QUALITY_AVIF: "75" | "80";
		FORMAT_QUALITY_JPEG: "80" | "85";
		FORMAT_QUALITY_PNG: "85" | "90";
		DEFAULT_QUALITY: "80" | "85";
		DEFAULT_FIT: "scale-down";
		USER_AGENT: "Cloudflare-Image-Resizer/1.0-DEV" | "Cloudflare-Image-Resizer/1.0-STAGING" | "Cloudflare-Image-Resizer/1.0-PROD";
		DERIVATIVES: {"thumbnail":{"width":320,"height":150,"quality":85,"fit":"scale-down","metadata":"none","sharpen":1},"avatar":{"width":180,"height":180,"quality":90,"fit":"cover","metadata":"none","gravity":"face"},"banner":{"width":1600,"height":400,"quality":80,"fit":"cover","metadata":"none"},"product":{"width":800,"height":800,"quality":85,"fit":"contain","background":"white","metadata":"none"},"header":{"width":1600,"height":73,"quality":80,"fit":"scale-down","metadata":"copyright"}};
		PATH_TRANSFORMS: {"images":{"prefix":"","removePrefix":true},"assets":{"prefix":"img/","removePrefix":true,"r2":{"prefix":"img/","removePrefix":true},"remote":{"prefix":"assets/","removePrefix":true},"fallback":{"prefix":"public/","removePrefix":true}},"content":{"prefix":"content-images/","removePrefix":true}};
		PATH_BASED_ORIGINS: {"productImages":{"pattern":"products/","priority":["remote","r2","fallback"],"remoteUrl":"https://cdn.erfianugrah.com","remoteAuth":{"enabled":false,"type":"bearer","tokenHeaderName":"Authorization","tokenSecret":""},"fetchOptions":{"headers":{"X-Product-API":"true"}}},"userUploads":{"pattern":"uploads/","priority":["r2","fallback"],"r2":{"enabled":true,"bindingName":"IMAGES_BUCKET"},"pathTransforms":{"uploads":{"prefix":"user-content/","removePrefix":true}}},"staticAssets":{"pattern":"assets/","priority":["remote"],"remoteUrl":"https://cdn.example.com/static","auth":{"useOriginAuth":false,"sharePublicly":true}},"profilePictures":{"pattern":"profiles/","priority":["r2","remote","fallback"],"pathTransforms":{"profiles":{"prefix":"avatars/","removePrefix":true}}}} | {"productImages":{"pattern":"products/","priority":["remote","r2","fallback"],"remoteUrl":"https://products.example.com/images","remoteAuth":{"enabled":true,"type":"bearer","tokenHeaderName":"Authorization","tokenSecret":""},"fetchOptions":{"headers":{"X-Product-API":"true"}}},"userUploads":{"pattern":"uploads/","priority":["r2","fallback"],"r2":{"enabled":true,"bindingName":"IMAGES_BUCKET"},"pathTransforms":{"uploads":{"prefix":"user-content/","removePrefix":true}}},"staticAssets":{"pattern":"assets/","priority":["remote"],"remoteUrl":"https://cdn.example.com/static","auth":{"useOriginAuth":false,"sharePublicly":true}},"profilePictures":{"pattern":"profiles/","priority":["r2","remote","fallback"],"pathTransforms":{"profiles":{"prefix":"avatars/","removePrefix":true}}}} | {"productImages":{"pattern":"products/","priority":["remote","r2","fallback"],"remoteUrl":"https://products-staging.example.com/images","remoteAuth":{"enabled":true,"type":"bearer","tokenHeaderName":"Authorization","tokenSecret":""}},"userUploads":{"pattern":"uploads/","priority":["r2","fallback"],"r2":{"enabled":true,"bindingName":"IMAGES_BUCKET"}},"staticAssets":{"pattern":"assets/","priority":["remote"],"remoteUrl":"https://staging-cdn.example.com/static"}} | {"productImages":{"pattern":"products/","priority":["remote","fallback"],"remoteUrl":"https://products-api.example.com/images","remoteAuth":{"enabled":true,"type":"bearer","tokenHeaderName":"Authorization"}},"userUploads":{"pattern":"uploads/","priority":["r2"],"r2":{"enabled":true,"bindingName":"IMAGES_BUCKET"}},"staticAssets":{"pattern":"assets/","priority":["remote"],"remoteUrl":"https://cdn.example.com/static","auth":{"useOriginAuth":false,"sharePublicly":true}},"profilePictures":{"pattern":"profiles/","priority":["r2"],"pathTransforms":{"profiles":{"prefix":"avatars/","removePrefix":true}}}};
		AUTH_SECURITY_LEVEL: "permissive" | "strict";
		AUTH_CACHE_TTL: "60" | "3600" | "86400";
		AUTH_USE_ORIGIN_AUTH: "true";
		AUTH_SHARE_PUBLICLY: "true";
		REMOTE_AUTH_ENABLED: "true";
		REMOTE_AUTH_TYPE: "aws-s3" | "r2";
