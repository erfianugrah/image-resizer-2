...
describe('ParameterHandler', () => {
  ...
  describe('handleRequest', () => {
    ...
    it('should handle compact parameters', () => {
    ...
    it('should handle size code parameters', () => {
    ...
    it('should handle Akamai parameters', () => {
    ...
    it('should handle multiple parameter formats in the same request', () => {
    ...
    it('should handle the ctx parameter (new name for smart)', () => {
    ...
    it('should handle the s parameter (compact form for ctx/smart)', () => {
    ...
    it('should handle the legacy smart parameter', () => {
    ...
    it('should automatically set ctx=true when aspect is specified', () => {
